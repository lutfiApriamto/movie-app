...
const App = () => {
  ...
  return (
    <>
      ...
      <section
        id="Hero"
        className="w-full bg-slate-900 pt-24 h-[60vh] bg-cover bg-top bg-no-repeat bg-fixed flex justify-center items-center"
        style={{ backgroundImage: `url(${image})` }}
      >
        <div className="container w-full h-full justify-center items-center">
          <div className="flex flex-wrap justify-center items-center">
            <h1 className="font-extrabold text-2xl sm:text-3xl  lg:text-4xl  text-red-600  w-full text-center mb-7 tracking-wider lg:tracking-normal">
              Lucha Movies
            </h1>
            ...
            <div className="w-3/4 py-2 px-3 flex bg-white rounded-lg justify-between box-content lg:w-1/2">
              ...
              <button
                className="py-1 px-3 bg-red-600 text-black font-bold rounded-md"
      ...
      <section id="main" className="pt-6">
        <div className="w-full md:h-1/2 container mx-auto px-6 sm:flex sm:flex-wrap sm:justify-center gap-6">
          {data &&
            data.map((movie) => (
              <div
                className="rounded-md shadow-lg overflow-hidden mb-10 sm:mb-0 sm:w-5/6 md:w-2/5 flex bg-black"
                key={movie.imdbID}
              >
                ...
                <div className="w-1/2 p-4 flex flex-col justify-between">
                  <div>
                    ...
                    <p className="text-white font-thin text-sm sm:text-sm">
                      {movie.Year}
                    </p>
                  </div>
