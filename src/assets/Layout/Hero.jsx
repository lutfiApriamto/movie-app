...
const Hero = () => {
    return (
        <section id="Hero" className="w-full bg-slate-900 pt-32 lg:pt-40 md:h-[60vh] h-[75vh] bg-cover bg-top bg-no-repeat bg-fixed flex justify-center " style={{ backgroundImage: `url(${image})` }}>
